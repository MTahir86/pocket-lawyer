...
const english: Strings = {
  ...
  errUnsupported: "Only PDF, JPG, PNG and DOCX files are supported.",
...
const urdu: Strings = {
  ...
  formats: "پی ڈی ایف، جے پی جی اور پی این جی DOCX",
  ...
  errUnsupported: " صرف پی ڈی ایف، جے پی جی اور پی این جی DOCX فائلیں قابلِ قبول ہیں۔",
...
const romanUrdu: Strings = {
  ...
  errUnsupported: "Sirf PDF, JPG PNG aur DOCX files support hoti hain.",
